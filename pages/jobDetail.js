...
export default function JobDetail() {
  ...
  return (
    <div > 
        {jobs && jobs.data?.map(jobd => (
        <>
            <h2 className="font-medium px-10 py-5">{jobd.type}/{jobd.location}</h2>
          ...
          <div className="grid grid-cols-2 divide-x">
            <ul className="w-200 divide-y divide-gray-200 dark:divide-gray-700 px-10 py-2 border border-gray-100">
                ...
                <div className='mt-6'>
              <div className='text-gray-700 '><div dangerouslySetInnerHTML={{ __html: jobd.description}} /></div>
            </div>
                </li>
            </ul>
            <div>
            ...
            <div className="max-w-sm p-10 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 py-10">            
              ...
              <div>
              <div className='flex ' dangerouslySetInnerHTML={{ __html: jobd.how_to_apply}} />
                </div>           
            </div>
            </div>
            </div>
